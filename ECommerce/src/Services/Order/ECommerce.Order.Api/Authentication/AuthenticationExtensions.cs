...
public static class AuthenticationExtensions
{
        ...
        IConfiguration configuration)
    {
        services
            ...
            .Validate(x => HasValidSigningKey(x.SigningKey),
                "Jwt:SigningKey must be a Base64 value containing at least 32 bytes.")
            .ValidateOnStart();
    ...
    private static bool HasValidSigningKey(string? signingKey)
    {
